...
export class GameLevel extends Scene {
    constructor(game) {
        super(game);
        this.stairsLeftTiles = new SpriteSheet({
            imageName: 'stairsLeft',
            imageWidth: 300,// уточнить размеры у нее как основной канвас сделан
            imageHeight: 600
        });
        this.stairsLeft = this.stairsLeftTiles.getSprite(7);//*******добавляем левую часть курятника
